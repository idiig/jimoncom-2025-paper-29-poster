...
\begin{minipage}{\textwidth}
  \begin{minipage}{\textwidth}
    \includesvg[height=.20\textwidth]{../figs/deduction-circle-macro}%
    \hspace{-1em}{\large は多い}
  \end{minipage}\\
  \tikz[baseline=(content.base)]{
    \node[inner sep=0pt] (content) {%
      \begin{minipage}{\textwidth}
        \includesvg[height=.20\textwidth]{../figs/deduction-circle-micro}%
    ...
    \begin{scope}[on background layer]
      \shade[outer color=pink!50, inner color=white] (content.center) ellipse (5cm and 1.6cm);
    \end{scope}
  }
\end{minipage}
